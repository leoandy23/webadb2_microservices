...
export declare class ProjectsController {
    ...
    findRecentProjects(userId: string): Promise<import("./entities/project.entity").Project[]>;
    findProjectsByUser(userId: string): Promise<import("./entities/project.entity").Project[]>;
}
